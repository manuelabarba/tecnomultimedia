...
void draw() {
  ...
  if(estado=="camascomodas"){
    ...
    fill(0);
    text("En la habitación hay camas muy cómodas",400,50);
    fill(255);
    rect(50,250,300,50);
    rect(400,250,300,50);
    fill(0);
  ...
  if(estado=="sueno"){
    image(sueno,0,0);
    fill(0);
    text("Luego de comer, a Ricitos le agarra sueño",400,50);
    fill(255);
    rect(50,300,300,50);
    rect(400,300,300,50);
    fill(0);
  ...
  if(estado=="asustan"){
    image(asustan,0,0);
    fill(255);
    text("Llegaron los osos, te vieron durmiendo y te asustaste", 400,250,300,100);
    fill(255);
